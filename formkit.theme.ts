...
/**
  ...
  *
  * @checksum - 7444bfae3b7e028791b8fdc452f31427a795b7963e54162da517c308858c4983
  * @variables - radius=rounded-lg,accentColor=cyan,colorTemperature=slate,spacing=2,scale=sm,inputShadow=shadow,baseColorShade=600,borderShadeLightMode=400,borderShadeDarkMode=500,inputMaxWidth=max-w-none,tagRadius=rounded-full,swatchRadius=rounded
  * @theme - regenesis
  **/
